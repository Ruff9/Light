...
translate([0,0,hauteur_1])
	rondelle(hauteur_rondelle, rayon_exterieur_1, rayon_interieur_2);
...
for ( i= [0:nb_attache_douille] )
	...
	rotate([0,0,i*(360/nb_attache_douille)]) {
		translate([0, rayon_exterieur_2+2, (hauteur_1 + hauteur_2/2)])
			rotate([90,0,0]) {
				cylinder((rayon_exterieur_2 - rayon_interieur_2 +2), 1, 1, $fn=60);
			}
	}